              ...
              <div className="flex flex-col bg-white w-fit h-fit gap-5 sm:gap-10 px-10 py-[30px] lg:px-20 lg:py-[60px] justify-center items-center border-4 border-black rounded-2xl">
                ...
                <div className="max-w-[600px] flex flex-col items-center gap-5 sm:gap-10">
                  ...
                  <p className="text-xl leading-7">
                    ...
                    ipsum ipsum sed viverra. At sit faucibus ipsum in in lacus
                    id. Felis cursus scelerisque nisl laoreet sit. Scelerisque
                    dui auctor pellentesque massa lorem egestas sit elementum.
                ...
                <div className="flex flex-col gap-5 max-w-[324px] lg:w-[480px]">
                  ...
                  <div className="flex flex-col gap-2.5">
                    ...
                    <p className="leading-5">
                      Lorem ipsum dolor sit amet consectetur. Nisi neque
                      faucibus a urna natoque enim sed dolor viverra. Ut purus
                      vitae massa etiam neque quis. Sit eget in malesuada cursus
                      enim eget ac. Sed sed quis ipsum turpis pharetra erat diam
                      tincidunt. Aliquam lobortis eu aliquam semper sed.
                    </p>
                  </div>
                </div>
                <div className="flex flex-col gap-5 max-w-[324px] lg:w-[480px]">
